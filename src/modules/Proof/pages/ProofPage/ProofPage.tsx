...
import { GetAllProofsQuery } from 'src/modules/StudentManagement/services/Proof'
...
const ProofPage = () => {
  ...
  const SortProof = useSorting({ queryConfig: queryProofConfig, pathname: path.proofs })
