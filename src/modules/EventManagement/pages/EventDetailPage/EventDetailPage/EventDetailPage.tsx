      ...
      <div className=''>
        ...
        {event && (
          <div className='relative bg-white w-full h-full pb-[100px] '>
            <div className='flex mb-8 px-[120px] justify-between'>
              <div className='flex flex-col'>
                <h1 className='text-black text-[80px] font-semibold break-words leading-tight'>{event.name}</h1>
                <h5 className='text-[#A0A2A4] text-[20px] font-light break-words mb-1'>{event.introduction}</h5>
              ...
              <div className='flex justify-between items-end'>
                {!event.isRegistered ? (
                    ...
                    <span className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-[16px] font-medium text-green-700 ring-1 ring-inset ring-green-600/20">Đã đăng ký.</span>
                  )}
              </div>
            </div>
            <div className='relative mb-[200px] px-[120px]'>
              ...
              <div className='bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] w-[80%] absolute right-0 left-0 mx-auto bottom-[-160px] grid grid-cols-3 px-10 py-8 rounded-2xl gap-4'>
                ...
                <div className='col-span-1 flex  justify-center'>
                  {mapImageURL && (
                    <img src={mapImageURL} alt='Static Map' className='object-cover rounded-2xl' />
                  )}
                </div>
                  ...
                  <div className='gap-2 flex flex-col'>
                    ...
                    <div className='flex gap-2'>
                      ...
                      <span className='text-[#A0A2A4] text-[15px] font-normal break-words'>
                        {formatDateTime(event.registrationInfos.find(e => e.id == event.nearestRegistrationInfoId)!.startAt) +
                          ' - ' +
                          formatDateTime(event.registrationInfos.find(e => e.id == event.nearestRegistrationInfoId)!.endAt)}
                      </span>
                    </div>
                  </div>
                  <div className='gap-2 flex flex-col'>
                    ...
                    <div className='flex gap-2'>
                      ...
                      <span className='text-[#A0A2A4] text-[15px] font-normal break-words'>
                        {formatDateTime(event.attendanceInfos.find(e => e.id == event.nearestAttendanceInfoId)!.startAt) +
                          ' - ' +
                          formatDateTime(event.attendanceInfos.find(e => e.id == event.nearestAttendanceInfoId)!.endAt)}
                      </span>
                    </div>
                  </div>
                </div>
