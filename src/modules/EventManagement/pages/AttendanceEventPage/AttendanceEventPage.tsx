...
const AttendanceEventPage = () => {
  ...
  useEffect(() => {
    ...
    queryEventQRConfig.Code,
    queryEventQRConfig.EventId,
    isSuccess,
      ...
      <div className='flex h-[calc(100vh-80px)] w-full items-center justify-center bg-white p-5'>
        {!isHandle.state && !isSuccess && location.error == 0 && (
          <div className='flex flex-col items-center'>
            ...
            <h1 className='mt-5 text-[20px] font-bold text-slate-800 lg:text-[30px]'>Đang xử lý yêu cầu</h1>
          </div>
        )}
        {isSuccess && (
          <div className='text-center'>
            ...
            <p className='mt-2 text-[16px]'>Cảm ơn bạn đã dành thời gian với chúng tôi!</p>
          </div>
        )}
