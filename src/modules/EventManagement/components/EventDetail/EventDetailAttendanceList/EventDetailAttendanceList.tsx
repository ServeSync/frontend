...
import { GetAttendanceStudentsQuery } from 'src/modules/EventManagement/services'
...
const EventDetailAttendanceList = () => {
  ...
  return (
    <div>
      <div>
        {attendanceStudents && attendanceStudents.total > 0 ? (
          <div>
            ...
            <Pagination
              ...
              pageSize={attendanceStudents.totalPage}
              pathname={path.event}
