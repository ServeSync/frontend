      ...
      {tab === index && (
        <div className='md:py-5 md:px-4'>
          <div className='col-span-2'>
            <p className='font-semibold md:text-[16px] text-[12px]'>Kết quả tham gia hoạt động phục vụ cộng đồng</p>
            ...
            <div className='mb-4'>
              <div className='flex justify-between items-center'>
                <p className='font-semibold md:text-[16px] text-[12px]'>
                  Danh sách hoạt động phục vụ cộng đồng sinh viên đã tham gia
                </p>
