  ...
  return (
    <div className=''>
      <header className='relative max-w-screen-xl w-full h-auto flex justify-between items-center py-8 px-4 top-0 left-0 right-0 bg-transparent z-50 mx-auto'>
        <div className='flex w-56 items-center font-normal text-[26px] gap-4 leading-10 font-serif'>
        ...
        <div className='font-medium items-center text-[14px] hidden lg:flex gap-4'>
          <Link
            ...
            className=' text-black px-4 py-4 rounded-3xl  transition-all duration-300 hover:shadow-md  no-underline flex-shrink-0 border shadow-sm'
          >
            Yêu cầu sự kiện
          </Link>
          <Link
