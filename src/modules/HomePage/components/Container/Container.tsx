...
import { landingPageImage, landingPageImage2, landingPageImage3 } from 'src/modules/Share/constants'
            ...
            {eventsUpcoming && eventsUpcoming.data.length === 0 && (
              <div className='flex w-full items-center justify-center'>
                <div className='text-center'>
                  ...
                  <p className='mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]'>
