...
const ChangePassword = ({ handleCloseModal }: Props) => {
  ...
  return (
    <div className='flex flex-col justify-between gap-6 items-center bg-white p-6 rounded-lg w-[480px]'>
      <div className='flex justify-between items-center w-full'>
        <h2 className='text-[20px] font-semibold'>Thay mật khẩu mới</h2>
