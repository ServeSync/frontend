...
const CollaborationRequestInformationForm = ({ collaborationRequest }: Props) => {
  ...
  const center = useMemo(() => {
    return {
      latitude: collaborationRequest?.address?.latitude,
      longitude: collaborationRequest?.address?.longitude
    }
  ...
  const contentState = convertFromHTML(collaborationRequest.description as string)
        ...
        <div className='grid grid-cols-12 gap-x-6 gap-y-4'>
          ...
          <div className='col-span-12 flex selection:items-center justify-between gap-2'>
            <div className='flex gap-x-2'>
              ...
              <span className='w-full text-black/90 text-[16px] bg-transparent'>
                {collaborationRequest.introduction}
              </span>
            </div>
            <div
              className={classNames('px-4 py-2 rounded-full h-[40px]', {
                'bg-[#26dc9c] text-white': collaborationRequest.status === 'Approved',
                'bg-[#fca310] text-white': collaborationRequest.status === 'Expired',
                'bg-[#195E8E] text-white': collaborationRequest.status === 'Pending',
                'bg-[#ff4d4f] text-white': collaborationRequest.status === 'Rejected'
              })}
            >
              {StatusToMessage(collaborationRequest.status as string)}
            </div>
          </div>
          <div className='col-span-4'>
            <img src={collaborationRequest.imageUrl} alt='' className='object-cover rounded-2xl w-full h-full' />
          </div>
          <div className='col-span-8 grid grid-cols-12 gap-4'>
            <div className='col-span-6'>
              <TextField
                ...
                value={formatDateTime(collaborationRequest.startAt)}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-6'>
              <TextField
                ...
                value={formatDateTime(collaborationRequest.endAt)}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-12'>
              <TextField
                className='w-full'
                label='Địa điểm'
                value={collaborationRequest.address.fullAddress}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-6'>
              <TextField
                className='w-full'
                label='Kinh độ'
                value={collaborationRequest.address.longitude}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-5'>
              <TextField
                className='w-full'
                label='Vĩ độ'
                value={collaborationRequest.address.latitude}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-6'>
              <TextField
                className='w-full'
                label='Loại sự kiện'
                value={TypeToMessage(collaborationRequest.type)}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-6'>
              <TextField
                ...
                value={collaborationRequest.capacity}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-6'>
              <TextField
                ...
                value={collaborationRequest.activity.eventCategoryName}
                InputProps={{
                  readOnly: true
                }}
              />
            ...
            <div className='col-span-6'>
              <TextField
                ...
                value={collaborationRequest.activity.name}
                InputProps={{
                  readOnly: true
                }}
              />
