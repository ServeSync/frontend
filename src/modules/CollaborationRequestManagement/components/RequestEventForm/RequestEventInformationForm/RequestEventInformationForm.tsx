...
import Map from 'src/modules/EventManagement/components/Map'
import { EventActivityType, EventCategoryType, LocationType, MarkerType } from 'src/modules/EventManagement/interfaces'
import { FormSearchMapSchema, FormSearchMapType } from 'src/modules/EventManagement/utils'
import { eventType } from 'src/modules/EventManagement/constants'
...
const RequestEventInformationForm = ({
  register,
  control,
  errors,
  setValue,
...
export default RequestEventInformationForm
