...
interface Props {
  ...
  errors: FieldErrors<FormSignInType>
  isLoading: boolean
}

const AdminSignInForm = ({ register, errors, isLoading }: Props) => {
  ...
  return (
    <div className='flex flex-col lg:gap-2 md:gap-1'>
      ...
      <div className='md:mt-12 max-md:mt-4'>
        <span className='md:text-[12px] max-md:text-[8px]'>Muốn hợp tác với chúng tôi ? </span>
        <Link
          to={'/!'}
